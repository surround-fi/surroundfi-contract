...
use surroundfi::{assert_eq_with_tolerance, prelude::*, state::surroundfi_group::BankVaultType};
...
#[tokio::test]
async fn surroundfi_account_withdraw_success(
    deposit_amount: f64,
    withdraw_amount: f64,
    bank_mint: BankMint,
) -> anyhow::Result<()> {
    ...
    let surroundfi_account_f = test_f.create_surroundfi_account().await;
    ...
    let surroundfi_account = surroundfi_account_f.load().await;
...
#[tokio::test]
async fn surroundfi_account_withdraw_all_success(
    deposit_amount: f64,
    bank_mint: BankMint,
) -> anyhow::Result<()> {
    // -------------------------------------------------------------------------
...
#[tokio::test]
async fn surroundfi_account_withdraw_failure_withdrawing_too_much(
    deposit_amount: f64,
    withdraw_amount: f64,
    bank_mint: BankMint,
) -> anyhow::Result<()> {
    ...
    let res = surroundfi_account_f
        ...
        .await;
    assert!(res.is_err());
    assert_custom_error!(res.unwrap_err(), SurroundfiError::OperationWithdrawOnly);
