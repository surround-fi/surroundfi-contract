...
use surroundfi::{
    ...
    state::surroundfi_group::{BankConfig, BankVaultType},
};
...
#[tokio::test]
async fn surroundfi_group_handle_bankruptcy_failure_not_bankrupt(
    ...
    let lp_mfi_account_f = test_f.create_surroundfi_account().await;
    ...
    let user_mfi_account_f = test_f.create_surroundfi_account().await;
    ...
    assert!(res.is_err());
    assert_custom_error!(res.unwrap_err(), SurroundfiError::AccountNotBankrupt);
...
#[test_case(BankMint::T22WithFee, BankMint::Sol)]
#[tokio::test]
async fn surroundfi_group_handle_bankruptcy_failure_no_debt(
    collateral_mint: BankMint,
    debt_mint: BankMint,
) -> anyhow::Result<()> {
    // -------------------------------------------------------------------------
    ...
    assert!(res.is_err());
    assert_custom_error!(res.unwrap_err(), SurroundfiError::BalanceNotBadDebt);
...
#[test_case(BankMint::T22WithFee, BankMint::Sol)]
#[tokio::test]
async fn surroundfi_group_handle_bankruptcy_success(
    collateral_mint: BankMint,
    debt_mint: BankMint,
) -> anyhow::Result<()> {
    // -------------------------------------------------------------------------
...
#[tokio::test]
async fn surroundfi_group_handle_bankruptcy_success_fully_insured(
    borrow_amount: f64,
    collateral_mint: BankMint,
    debt_mint: BankMint,
) -> anyhow::Result<()> {
    ...
    assert!(res.is_err());
    assert_custom_error!(res.unwrap_err(), SurroundfiError::AccountDisabled);
...
#[tokio::test]
async fn surroundfi_group_handle_bankruptcy_success_partially_insured(
    borrow_amount: f64,
...
#[test_case(10_000., BankMint::T22WithFee, BankMint::Sol)]
#[tokio::test]
async fn surroundfi_group_handle_bankruptcy_success_not_insured(
    borrow_amount: f64,
    collateral_mint: BankMint,
    debt_mint: BankMint,
) -> anyhow::Result<()> {
...
#[tokio::test]
async fn surroundfi_group_handle_bankruptcy_success_not_insured_3_depositors() -> anyhow::Result<()> {
    ...
    let lender_1_mfi_account_f = test_f.create_surroundfi_account().await;
    ...
    let lender_2_mfi_account_f = test_f.create_surroundfi_account().await;
    ...
    let lender_3_mfi_account_f = test_f.create_surroundfi_account().await;
    ...
    let borrower_mfi_account_f = test_f.create_surroundfi_account().await;
