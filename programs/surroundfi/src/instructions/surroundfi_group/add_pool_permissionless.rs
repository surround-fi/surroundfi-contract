...
use crate::{
    ...
    state::{
        surroundfi_group::{
            Bank, BankConfigCompact, BankOperationalState, InterestRateConfig, SurroundfiGroup,
        },
        price::OracleSetup,
...
pub fn lending_pool_add_bank_permissionless(
    ...
    let mut group = ctx.accounts.surroundfi_group.load_mut()?;
