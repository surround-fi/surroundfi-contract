...
pub const ORACLE_MIN_AGE: u16 = 0; // TODO: change back to 30 when testing done
pub const MAX_PYTH_ORACLE_AGE: u64 = 3600 * 24 * 365; // TODO: change back to 60 when testing done
...
pub const PYTH_PUSH_SURROUNDFI_SPONSORED_SHARD_ID: u16 = 3301;
